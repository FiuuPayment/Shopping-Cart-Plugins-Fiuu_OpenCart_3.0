...
$_['text_molpay']	     			= '<a onclick="window.open(\'https://merchant.razer.com/\');" style="text-decoration:none;"><img src="view/image/payment/logo_RazerMerchantServices.png" alt="Razer Merchant Services" title="Razer Merchant Services" style="border: 0px solid #EEEEEE;" width="100px"/></a>';
