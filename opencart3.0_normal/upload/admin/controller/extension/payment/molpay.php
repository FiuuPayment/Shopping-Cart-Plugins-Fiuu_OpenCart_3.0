...
class ControllerExtensionPaymentMOLPay extends Controller {
	...
	public function install() {
		...
		$this->model_user_user_group->addPermission($this->user->getGroupId(), 'access', 'extension/payment/molpay');
		$this->model_user_user_group->addPermission($this->user->getGroupId(), 'modify', 'extension/payment/molpay');
	}
