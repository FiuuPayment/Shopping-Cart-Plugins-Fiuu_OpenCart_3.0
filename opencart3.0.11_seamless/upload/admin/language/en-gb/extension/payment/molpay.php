...
$_['text_molpay']	     			= '<a onclick="window.open(\'https://fiuu.com/\');" style="text-decoration:none;"><img src="view/image/payment/logo_Fiuu.png" alt="Fiuu" title="Fiuu" width="100px"/></a>';
...
$_['error_settings']       			= 'Fiuu merchant ID and verify key mismatch, contact support-sa@fiuu.com for assistance.';
