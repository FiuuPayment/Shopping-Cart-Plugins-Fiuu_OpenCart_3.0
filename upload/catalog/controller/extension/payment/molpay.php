...
class ControllerExtensionPaymentMolpay extends Controller {
        ...
        else
        {
            ...
            $telephone = $this->customer->getTelephone();
                ...
                $data['js'] = $this->config->get('payment_molpay_type').'RMS/API/seamless/3.28/js/MOLPay_seamless.deco.js';
        ...
        {	
            ...
            ************************************************************/
            ...
            $url        = $this->config->get('payment_molpay_type')."RMS/API/chkstat/returnipn.php";
            $ch         = curl_init();
